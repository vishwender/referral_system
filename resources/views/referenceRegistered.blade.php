...
<form action="{{route('registered')}}" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" name="reference_code" value="{{$reference}}" class="form-control"  id="reference_code" placeholder="Enter Refernce code-(optional)" disabled/>
        <input type="hidden" name="reference_code" value="{{$reference}}" class="form-control" />
    </div>
    <div class="form-group">
